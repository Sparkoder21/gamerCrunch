...
function loadify(options){
  ...
  let alertTitle = document.createElement('div');
  alertTitle.className = 'alertTitle';
  alertTitle.innerHTML = '<p>&nbsp</p>';
  children.push(alertTitle);
  //--Alert Content--
  let alertContent = document.createElement('div');
  alertContent.className='alertContent';
  alertContent.innerHTML= options.darkMode ? 
  `
    <div id="loader">
      <div id="loader-text-dark">
        <h1> Loading </h1>
      </div>
      <div id="loader-ring-dark"></div>
    </div>
  ` : 
  `
    <div id="loader">
...
export {alertify, toastify, loadify, loadified};